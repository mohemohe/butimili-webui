	...
	public render() {
		...
		return (
			<div className={styles.root}>
				...
				<form className={styles.loginCardWrapper} onSubmit={(event) => {
					event.preventDefault();
					this.props.AuthStore!.login(this.state.name, this.state.password);
                }}>
					<Card className={styles.loginCard}>
						...
						<CardActions className={styles.loginActions}>
							<div className={styles.loginButtons}>
								<Button type={"submit"} fullWidth variant="raised" classes={{root: styles.loginButton}}>
									<Send/>
